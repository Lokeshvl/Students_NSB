...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  $usn = $_POST["usn"];
  $email=$_POST["email"];
  $existSql ="SELECT * FROM `scholarship` WHERE PhoneNo = '$usn' AND Email='$email'";
...
elseif($numExistRows>=1 OR $numExistRows>1){
  ...
  header("location:buspass.php");
   ...
   $sql = "INSERT INTO `scholarship` (`UserName`, `PhoneNo`, `Email`, `dt`) VALUES ('$username', '$usn', '$email', current_timestamp())";
...
<div class="con1">
<h2 class="text-center my-2">Login to  Students scholarships</h2>
<div class="container my-3">
     <form action="\studentnsb\scholarshipTable.php" method="post">
